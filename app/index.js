...
let aText = new Array(
  '', 'Hello there.', 'I am Isaac.', '', 'Welcome to my digital portfolio where you can find my past and current work!', 'If you have any questions, feel free to reach out to me using the navigation or the icons on the left.', 'For resume, click on the "resume" icon or just type "resume"',
  );
